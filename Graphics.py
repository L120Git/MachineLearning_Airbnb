...
class Graphics:
    def __init__(self, path: str = "./imagesAirbnbML/"):
        self.path = path  # initialize the directory

    def heatmap(self, df: pd.DataFrame, target_name: str, file_name: str) -> None:
        """
        ...
        if not os.path.exists(f'{self.path}{file_name}'):
            ...
            print(f'{self.path}{file_name} has been successfully created')
        else:
            print(f'{self.path}{file_name} already exist')

    def histogram(self, df: pd.Dataframe, file_name: str, object_type) -> None:
        """
    ...
    def scatter(self, df: pd.DataFrame, file_name: str) -> None:
        """
    ...
    def aplhavalues(self, alpha_vector, scores, file_name):
        """
        create and save plot alpha values
        :param alpha_vector: a vector of alpha values
        :param scores: scores of df
        :param file_name: name and extension file
        :return: None
        """
